  ...
  'pt-BR': {
    ...
    techStack: {
      ...
      categories: [
        ...
        { category: 'Linux, Scripting & Bancos', tools: ['Linux (Debian · RHEL · CentOS)', 'Bash · PowerShell · Python', 'PostgreSQL · MySQL · MongoDB', 'Oracle DB · SQL Server', 'Power BI'] },
  ...
  en: {
    ...
    techStack: {
      ...
      categories: [
        ...
        { category: 'CI/CD & GitOps', tools: ['GitHub Actions', 'GitLab CI', 'Jenkins', 'Git · Gitea'] },
        { category: 'Observability & SRE', tools: ['Prometheus', 'Grafana', 'Zabbix', 'Wazuh'] },
        { category: 'Linux, Scripting & Databases', tools: ['Linux (Debian · RHEL · CentOS)', 'Bash · PowerShell · Python', 'PostgreSQL · MySQL · MongoDB', 'Oracle DB · SQL Server', 'Power BI'] },
        { category: 'AI & LLM Ops', tools: ['Gemini CLI', 'Claude', 'OpenAI', 'Hugging Face'] },
      ],
    },
    certs: {
